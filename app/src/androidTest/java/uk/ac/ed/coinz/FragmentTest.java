...
public class FragmentTest {
    ...
    public void setUp() throws Exception {
        mRuntimePermissionRule = GrantPermissionRule.grant(android.Manifest.permission.ACCESS_FINE_LOCATION);
    }
    ...
    public void fragmentTest() {
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.LoginUsername), withText("1"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                1),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("123@gmail.com"));
        ...
        ViewInteraction listView = onView(
                allOf(withId(R.id.wallet_listView),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction frameLayout = onView(
                allOf(withId(R.id.nav_wallet), withContentDescription("Wallet"),
                        childAtPosition(
                                childAtPosition(
